...
class BoxDoctorByClinic extends Component {
    ...
    async componentDidMount() {
        let dataDoctorBySpecialty = await getDoctorBySpecialtyIdService({ id: this.props.match.params.id, date: this.state.currentDay })
    ...
    render() {
        ...
        // let dataDoctorEdited = this.handleChangeProvince({ target: { value: 'ALL' } })
        // let schedule = dataDoctorBySpecialty ? dataDoctorBySpecialty.timeSchedule : []

        // console.log(this.state.dataDoctorByProvince);
        ...
        return (
            <>
                box doctor
                {/* <div className="box-doctor-container">
                ...
                {/* {this.state.isShowModal && <Modal
                    ...
                    // currentDay={this.state.dataDoctorByProvince.currentDay}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(BoxDoctorByClinic));
